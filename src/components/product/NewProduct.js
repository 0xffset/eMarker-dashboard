        ...
        <Grid container spacing={2}>
          <Grid item>
            ...
            <ButtonBase className={classes.image}>
              <img className={classes.img} alt="complex" src={values.image ? URL.createObjectURL(values.image) : "http://react-material.fusetheme.com/assets/images/ecommerce/product-image-placeholder.png"} />
            </ButtonBase>
          </Grid>
            ...
            <Grid item xs container direction="column" spacing={2}>
              <Grid item xs>
                <Typography gutterBottom variant="subtitle1">
                 {values.name ? values.name : "Product Name"}
                </Typography>
